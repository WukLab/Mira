...
rring_init(rvid_ofld,  int,        s4_nb * sizeof(int),        s4_n_block, 0, 8192 + (20ULL << 30));
...
void calculate_distribution_store_and_fwd_flag()
{
    ...
    vid_newvec.head = (int *)(4096ULL + (20ULL << 30));
...
_lbase_rvid_ofld = (uint64_t) rbuf + (20ULL << 30) + (8192ULL);
