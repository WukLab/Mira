#map = affine_map<(d0) -> (-d0 + 257, 8)>
#set = affine_set<(d0) : (-d0 + 249 >= 0)>
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  func.func @main_graph(%arg0: memref<64x12x1x257xf32>, %arg1: memref<64x12x257x64xf32>) -> memref<64x12x1x64xf32> attributes {input_names = ["X1", "X2"], llvm.emit_c_interface, output_names = ["Y"]} {
    ...
    affine.for %arg2 = 0 to 64 {
      // %alloc [%arg2, 0->12, 0->1, 0->64]
      // %arg0 [%arg2, 0->12, 0->1, 0->257]
      // %arg1 [%arg2, 0->12, 0->257, 0->64]
      affine.for %arg3 = 0 to 12 {
        affine.for %arg4 = 0 to 1 {
          affine.for %arg5 = 0 to 64 step 8 {
            affine.for %arg6 = 0 to 257 step 8 {
              affine.if #set(%arg6) {
                ...
                affine.for %arg7 = 0 to 1 {
                  ...
                  %2 = memref.load %arg0[%arg2, %arg3, %0, %arg6] : memref<64x12x1x257xf32>
                  %3 = vector.broadcast %2 : f32 to vector<8xf32>
                  %4 = vector.load %arg1[%arg2, %arg3, %arg6, %arg5] : memref<64x12x257x64xf32>, vector<8xf32>
                  ...
                  %8 = memref.load %arg0[%arg2, %arg3, %0, %7] : memref<64x12x1x257xf32>
                  %9 = vector.broadcast %8 : f32 to vector<8xf32>
                  %10 = vector.load %arg1[%arg2, %arg3, %7, %arg5] : memref<64x12x257x64xf32>, vector<8xf32>
                  ...
                  %14 = memref.load %arg0[%arg2, %arg3, %0, %13] : memref<64x12x1x257xf32>
                  %15 = vector.broadcast %14 : f32 to vector<8xf32>
                  %16 = vector.load %arg1[%arg2, %arg3, %13, %arg5] : memref<64x12x257x64xf32>, vector<8xf32>
                  ...
                  %20 = memref.load %arg0[%arg2, %arg3, %0, %19] : memref<64x12x1x257xf32>
                  %21 = vector.broadcast %20 : f32 to vector<8xf32>
                  %22 = vector.load %arg1[%arg2, %arg3, %19, %arg5] : memref<64x12x257x64xf32>, vector<8xf32>
                  ...
                  %26 = memref.load %arg0[%arg2, %arg3, %0, %25] : memref<64x12x1x257xf32>
                  %27 = vector.broadcast %26 : f32 to vector<8xf32>
                  %28 = vector.load %arg1[%arg2, %arg3, %25, %arg5] : memref<64x12x257x64xf32>, vector<8xf32>
                  ...
                  %32 = memref.load %arg0[%arg2, %arg3, %0, %31] : memref<64x12x1x257xf32>
                  %33 = vector.broadcast %32 : f32 to vector<8xf32>
                  %34 = vector.load %arg1[%arg2, %arg3, %31, %arg5] : memref<64x12x257x64xf32>, vector<8xf32>
                  ...
                  %38 = memref.load %arg0[%arg2, %arg3, %0, %37] : memref<64x12x1x257xf32>
                  %39 = vector.broadcast %38 : f32 to vector<8xf32>
                  %40 = vector.load %arg1[%arg2, %arg3, %37, %arg5] : memref<64x12x257x64xf32>, vector<8xf32>
                  ...
                  %44 = memref.load %arg0[%arg2, %arg3, %0, %43] : memref<64x12x1x257xf32>
                  %45 = vector.broadcast %44 : f32 to vector<8xf32>
                  %46 = vector.load %arg1[%arg2, %arg3, %43, %arg5] : memref<64x12x257x64xf32>, vector<8xf32>
                ...
                affine.for %arg7 = 0 to 1 {
                  ...
                  affine.for %arg8 = 0 to min #map(%arg6) {
                    %3 = arith.addi %arg8, %arg6 : index
                    %4 = memref.load %arg0[%arg2, %arg3, %0, %3] : memref<64x12x1x257xf32>
                    %5 = vector.broadcast %4 : f32 to vector<8xf32>
                    %6 = vector.load %arg1[%arg2, %arg3, %3, %arg5] : memref<64x12x257x64xf32>, vector<8xf32>
                    %7 = affine.load %alloca[0] : memref<1xvector<8xf32>>
                    %8 = vector.fma %5, %6, %7 : vector<8xf32>
                    affine.store %8, %alloca[0] : memref<1xvector<8xf32>>
                  }
                  %2 = affine.load %alloca[0] : memref<1xvector<8xf32>>
                  vector.store %2, %alloc[%arg2, %arg3, %0, %arg5] : memref<64x12x1x64xf32>, vector<8xf32>
                }
              }
            }
          }
