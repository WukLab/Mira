...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  func.func @main_graph(%arg0: memref<64512x512xf32>, %arg1: memref<512x1024xf32>) -> memref<64512x1024xf32> attributes {
    ...
    %alloc = memref.alloc() {remote_target = 1, alignment = 16 : i64} : memref<64512x1024xf32>
    affine.for %arg2 = 0 to 64512 {
      affine.for %arg3 = 0 to 1024 {
        affine.store %cst, %alloc[%arg2, %arg3] : memref<64512x1024xf32>
      }
    }
    affine.for %arg2 = 0 to 64512 step 4 {
      affine.for %arg3 = 0 to 1024 step 8 {
        affine.for %arg4 = 0 to 512 step 8 {
          ...
          %0 = vector.load %alloc[%arg2, %arg3]  : memref<64512x1024xf32>, vector<8xf32>
          affine.store %0, %alloca[0] : memref<4xvector<8xf32>>
          %1 = arith.addi %arg2, %c1 : index
          %2 = vector.load %alloc[%1, %arg3]  : memref<64512x1024xf32>, vector<8xf32>
          affine.store %2, %alloca[1] : memref<4xvector<8xf32>>
          %3 = arith.addi %arg2, %c2 : index
          %4 = vector.load %alloc[%3, %arg3]  : memref<64512x1024xf32>, vector<8xf32>
          affine.store %4, %alloca[2] : memref<4xvector<8xf32>>
          %5 = arith.addi %arg2, %c3 : index
          %6 = vector.load %alloc[%5, %arg3]  : memref<64512x1024xf32>, vector<8xf32>
          ...
          affine.for %arg5 = 0 to 8 step 4 {
            ...
            %14 = vector.load %arg1[%11, %arg3]  : memref<512x1024xf32>, vector<8xf32>
            ...
            %21 = vector.load %arg1[%18, %arg3]  : memref<512x1024xf32>, vector<8xf32>
            ...
            %28 = vector.load %arg1[%25, %arg3]  : memref<512x1024xf32>, vector<8xf32>
            ...
            %35 = vector.load %arg1[%32, %arg3]  : memref<512x1024xf32>, vector<8xf32>
            ...
            %40 = vector.load %arg1[%11, %arg3]  : memref<512x1024xf32>, vector<8xf32>
            ...
            %45 = vector.load %arg1[%18, %arg3]  : memref<512x1024xf32>, vector<8xf32>
            ...
            %50 = vector.load %arg1[%25, %arg3]  : memref<512x1024xf32>, vector<8xf32>
            ...
            %55 = vector.load %arg1[%32, %arg3]  : memref<512x1024xf32>, vector<8xf32>
            ...
            %60 = vector.load %arg1[%11, %arg3]  : memref<512x1024xf32>, vector<8xf32>
            ...
            %65 = vector.load %arg1[%18, %arg3]  : memref<512x1024xf32>, vector<8xf32>
            ...
            %70 = vector.load %arg1[%25, %arg3]  : memref<512x1024xf32>, vector<8xf32>
            ...
            %75 = vector.load %arg1[%32, %arg3]  : memref<512x1024xf32>, vector<8xf32>
            ...
            %80 = vector.load %arg1[%11, %arg3]  : memref<512x1024xf32>, vector<8xf32>
            ...
            %85 = vector.load %arg1[%18, %arg3]  : memref<512x1024xf32>, vector<8xf32>
            ...
            %90 = vector.load %arg1[%25, %arg3]  : memref<512x1024xf32>, vector<8xf32>
            ...
            %95 = vector.load %arg1[%32, %arg3]  : memref<512x1024xf32>, vector<8xf32>
          ...
          vector.store %8, %alloc[%1, %arg3]  : memref<64512x1024xf32>, vector<8xf32>
          %9 = affine.load %alloca[2] : memref<4xvector<8xf32>>
          vector.store %9, %alloc[%3, %arg3]  : memref<64512x1024xf32>, vector<8xf32>
          %10 = affine.load %alloca[3] : memref<4xvector<8xf32>>
          vector.store %10, %alloc[%5, %arg3]  : memref<64512x1024xf32>, vector<8xf32>
        }
      }
    }
    return  %alloc : memref<64512x1024xf32>
  }
}
