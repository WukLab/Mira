module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func @_Z3sumRSt6vectorIiSaIiEE(%arg0: !llvm.ptr<!llvm.struct<"r::class.std::vector", (!llvm.struct<"r::struct.std::_Vector_base", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>) -> i32 {
    %c1_i32 = arith.constant 1 : i32
    %c0_i32 = arith.constant 0 : i32
    %0:2 = scf.while (%arg1 = %c0_i32, %arg2 = %c0_i32) : (i32, i32) -> (i32, i32) {
      %1 = arith.extsi %arg1 : i32 to i64
      %2 = func.call @remote_vec_size(%arg0) : (!llvm.ptr<!llvm.struct<"r::class.std::vector", (!llvm.struct<"r::struct.std::_Vector_base", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>) -> i64
      %3 = arith.cmpi slt, %1, %2 : i64
      scf.condition(%3) %arg2, %arg1 : i32, i32
    } do {
    ^bb0(%arg1: i32, %arg2: i32):
      %1 = arith.extsi %arg2 : i32 to i64
      %2 = func.call @remote_vec_idx(%arg0, %1) : (!llvm.ptr<!llvm.struct<"r::class.std::vector", (!llvm.struct<"r::struct.std::_Vector_base", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>, i64) -> !rmem.rmref<1, !llvm.ptr<i32>>
      %3 = rmem.llvm.load %2 : (!rmem.rmref<1, !llvm.ptr<i32>>) -> i32
  ...
  func.func @remote_vec_idx(%arg0: !llvm.ptr<!llvm.struct<"r::class.std::vector", (!llvm.struct<"r::struct.std::_Vector_base", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>, %arg1: i64) -> !rmem.rmref<1, !llvm.ptr<i32>> {
