...
#amap1 = affine_map<(d0) -> (d0 * 512)>
#amap2 = affine_map<(d0) -> (0)>
...
%arg0 = rmem.alloc_memref(2, ) {alignment = 16 : i64, access_mem_catcher = [["ref1", 0]]} : <1, memref<64512x512xf32>>
%arg1 = rmem.alloc_memref(2, ) {alignment = 16 : i64, access_mem_catcher = [["ref2", 0]]} : <1, memref<512x1024xf32>>
...
func.func private @save(%0: index) -> ()
