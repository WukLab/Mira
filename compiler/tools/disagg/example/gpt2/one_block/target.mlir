...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  ...
  func.func private @disagg_read_tensor_f32(!llvm.ptr<i8>, memref<*xf32>) attributes {llvm.emit_c_interface, operand_types = [!llvm.ptr<i8>, !rmem.rmref<1, memref<*xf32>>], remote_target = 1 : i64}
  ...
  func.func @main_graph(%arg0: memref<64x1xi64>, %arg1: memref<64x12x255x64xf32>, %arg2: memref<64x12x255x64xf32>) -> memref<64x1x50264xf32> attributes {input_names = ["input_ids", "past.0.key", "past.0.value"], llvm.emit_c_interface, operand_types = [memref<64x1xi64>, !rmem.rmref<1, memref<64x12x255x64xf32>>, !rmem.rmref<1, memref<64x12x255x64xf32>>], output_names = ["logits"], rel_types = [!rmem.rmref<1, memref<64x1x50264xf32>>], remote_target = 1 : i64} {
    ...
    %alloc_32 = memref.alloc() {alignment = 16 : i64, remote_target = 1 : i64} : memref<768x50264xf32>
    %cast_33 = memref.cast %alloc_32 {remote_check_use = 1 : i8} : memref<768x50264xf32> to memref<*xf32>
    %32 = llvm.mlir.addressof @constant_16 : !llvm.ptr<array<12 x i8>>
    %33 = llvm.getelementptr %32[0, 0] : (!llvm.ptr<array<12 x i8>>) -> !llvm.ptr<i8>
    call @read_tensor_f32(%33, %cast_33) {remote_callee = "disagg_read_tensor_f32", remote_check_use = 1 : i8, remote_target = 1 : i64} : (!llvm.ptr<i8>, memref<*xf32>) -> ()
    ...
    affine.for %arg3 = 0 to 64 {
      %70 = affine.load %reinterpret_cast[%arg3, 0] : memref<64x1xi64>
      %71 = llvm.mlir.addressof @str0 : !llvm.ptr<array<5 x i8>>
      %72 = llvm.getelementptr %71[0, 0] : (!llvm.ptr<array<5 x i8>>) -> !llvm.ptr<i8>
      %73 = llvm.call @printf(%72, %70) : (!llvm.ptr<i8>, i64) -> i32
    ...
    %alloc_62 = memref.alloc() {alignment = 16 : i64, remote_target = 1 : i64} : memref<64x12x256x64xf32>
    affine.for %arg3 = 0 to 64 {
      affine.for %arg4 = 0 to 12 {
        affine.for %arg5 = 0 to 255 {
          affine.for %arg6 = 0 to 64 {
            ...
            affine.store %70, %alloc_62[%arg3, %arg4, %arg5, %arg6] {remote_check_use = 1 : i8} : memref<64x12x256x64xf32>
          }
        }
      }
    }
      ...
      affine.for %arg4 = 0 to 12 {
        affine.for %arg5 = 0 to 1 {
          affine.for %arg6 = 0 to 64 {
            ...
            affine.store %70, %alloc_62[%arg3, %arg4, %arg5 + 255, %arg6] {remote_check_use = 1 : i8} : memref<64x12x256x64xf32>
          }
        }
      }
    }
    ...
    %alloc_64 = memref.alloc() {alignment = 16 : i64, remote_target = 1 : i64} : memref<64x12x64x256xf32>
    affine.for %arg3 = 0 to 64 {
      affine.for %arg4 = 0 to 12 {
        affine.for %arg5 = 0 to 256 {
          affine.for %arg6 = 0 to 64 {
            %70 = affine.load %alloc_62[%arg3, %arg4, %arg5, %arg6] {remote_check_use = 1 : i8} : memref<64x12x256x64xf32>
            affine.store %70, %alloc_64[%arg3, %arg4, %arg6, %arg5] {remote_check_use = 1 : i8} : memref<64x12x64x256xf32>
          }
        }
      }
    }
          ...
          affine.for %arg6 = 0 to 256 step 8 {
            affine.for %arg7 = 0 to 64 step 8 {
              ...
              affine.for %arg8 = 0 to 1 {
                ...
                %74 = vector.load %alloc_64[%arg3, %arg4, %arg7, %arg6] {remote_check_use = 1 : i8} : memref<64x12x64x256xf32>, vector<8xf32>
                ...
                %80 = vector.load %alloc_64[%arg3, %arg4, %77, %arg6] {remote_check_use = 1 : i8} : memref<64x12x64x256xf32>, vector<8xf32>
                ...
                %86 = vector.load %alloc_64[%arg3, %arg4, %83, %arg6] {remote_check_use = 1 : i8} : memref<64x12x64x256xf32>, vector<8xf32>
                ...
                %92 = vector.load %alloc_64[%arg3, %arg4, %89, %arg6] {remote_check_use = 1 : i8} : memref<64x12x64x256xf32>, vector<8xf32>
                ...
                %98 = vector.load %alloc_64[%arg3, %arg4, %95, %arg6] {remote_check_use = 1 : i8} : memref<64x12x64x256xf32>, vector<8xf32>
                ...
                %104 = vector.load %alloc_64[%arg3, %arg4, %101, %arg6] {remote_check_use = 1 : i8} : memref<64x12x64x256xf32>, vector<8xf32>
                ...
                %110 = vector.load %alloc_64[%arg3, %arg4, %107, %arg6] {remote_check_use = 1 : i8} : memref<64x12x64x256xf32>, vector<8xf32>
                ...
                %116 = vector.load %alloc_64[%arg3, %arg4, %113, %arg6] {remote_check_use = 1 : i8} : memref<64x12x64x256xf32>, vector<8xf32>
          ...
          affine.for %arg6 = 0 to 64 step 8 {
            affine.for %arg7 = 0 to 256 step 8 {
              ...
              affine.for %arg8 = 0 to 1 {
                ...
                %73 = vector.broadcast %72 : f32 to vector<8xf32>
                %74 = vector.load %alloc_63[%arg3, %arg4, %arg7, %arg6] {remote_check_use = 1 : i8} : memref<64x12x256x64xf32>, vector<8xf32>
                %75 = affine.load %alloca[0] : memref<1xvector<8xf32>>
                %76 = vector.fma %73, %74, %75 {remote_check_use = 1 : i8} : vector<8xf32>
                affine.store %76, %alloca[0] {remote_check_use = 1 : i8} : memref<1xvector<8xf32>>
                %77 = arith.addi %arg7, %c1 : index
                ...
                %79 = vector.broadcast %78 : f32 to vector<8xf32>
                %80 = vector.load %alloc_63[%arg3, %arg4, %77, %arg6] {remote_check_use = 1 : i8} : memref<64x12x256x64xf32>, vector<8xf32>
                %81 = affine.load %alloca[0] : memref<1xvector<8xf32>>
                %82 = vector.fma %79, %80, %81 {remote_check_use = 1 : i8} : vector<8xf32>
                affine.store %82, %alloca[0] {remote_check_use = 1 : i8} : memref<1xvector<8xf32>>
                %83 = arith.addi %arg7, %c2 : index
                ...
                %85 = vector.broadcast %84 : f32 to vector<8xf32>
                %86 = vector.load %alloc_63[%arg3, %arg4, %83, %arg6] {remote_check_use = 1 : i8} : memref<64x12x256x64xf32>, vector<8xf32>
                %87 = affine.load %alloca[0] : memref<1xvector<8xf32>>
                %88 = vector.fma %85, %86, %87 {remote_check_use = 1 : i8} : vector<8xf32>
                affine.store %88, %alloca[0] {remote_check_use = 1 : i8} : memref<1xvector<8xf32>>
                %89 = arith.addi %arg7, %c3 : index
                ...
                %91 = vector.broadcast %90 : f32 to vector<8xf32>
                %92 = vector.load %alloc_63[%arg3, %arg4, %89, %arg6] {remote_check_use = 1 : i8} : memref<64x12x256x64xf32>, vector<8xf32>
                %93 = affine.load %alloca[0] : memref<1xvector<8xf32>>
                %94 = vector.fma %91, %92, %93 {remote_check_use = 1 : i8} : vector<8xf32>
                affine.store %94, %alloca[0] {remote_check_use = 1 : i8} : memref<1xvector<8xf32>>
                %95 = arith.addi %arg7, %c4 : index
                ...
                %97 = vector.broadcast %96 : f32 to vector<8xf32>
                %98 = vector.load %alloc_63[%arg3, %arg4, %95, %arg6] {remote_check_use = 1 : i8} : memref<64x12x256x64xf32>, vector<8xf32>
                %99 = affine.load %alloca[0] : memref<1xvector<8xf32>>
                %100 = vector.fma %97, %98, %99 {remote_check_use = 1 : i8} : vector<8xf32>
                affine.store %100, %alloca[0] {remote_check_use = 1 : i8} : memref<1xvector<8xf32>>
                %101 = arith.addi %arg7, %c5 : index
                ...
                %103 = vector.broadcast %102 : f32 to vector<8xf32>
                %104 = vector.load %alloc_63[%arg3, %arg4, %101, %arg6] {remote_check_use = 1 : i8} : memref<64x12x256x64xf32>, vector<8xf32>
                %105 = affine.load %alloca[0] : memref<1xvector<8xf32>>
                %106 = vector.fma %103, %104, %105 {remote_check_use = 1 : i8} : vector<8xf32>
                affine.store %106, %alloca[0] {remote_check_use = 1 : i8} : memref<1xvector<8xf32>>
                %107 = arith.addi %arg7, %c6 : index
                ...
                %109 = vector.broadcast %108 : f32 to vector<8xf32>
                %110 = vector.load %alloc_63[%arg3, %arg4, %107, %arg6] {remote_check_use = 1 : i8} : memref<64x12x256x64xf32>, vector<8xf32>
                %111 = affine.load %alloca[0] : memref<1xvector<8xf32>>
                %112 = vector.fma %109, %110, %111 {remote_check_use = 1 : i8} : vector<8xf32>
                affine.store %112, %alloca[0] {remote_check_use = 1 : i8} : memref<1xvector<8xf32>>
                %113 = arith.addi %arg7, %c7 : index
                ...
                %115 = vector.broadcast %114 : f32 to vector<8xf32>
                %116 = vector.load %alloc_63[%arg3, %arg4, %113, %arg6] {remote_check_use = 1 : i8} : memref<64x12x256x64xf32>, vector<8xf32>
                %117 = affine.load %alloca[0] : memref<1xvector<8xf32>>
                %118 = vector.fma %115, %116, %117 {remote_check_use = 1 : i8} : vector<8xf32>
                affine.store %118, %alloca[0] {remote_check_use = 1 : i8} : memref<1xvector<8xf32>>
                %119 = affine.load %alloca[0] : memref<1xvector<8xf32>>
    ...
    %alloc_144 = memref.alloc() {alignment = 16 : i64, remote_target = 1 : i64} : memref<64x1x50264xf32>
    affine.for %arg3 = 0 to 64 {
      affine.for %arg4 = 0 to 1 {
        affine.for %arg5 = 0 to 50264 {
          affine.store %cst_1, %alloc_144[%arg3, %arg4, %arg5] {remote_check_use = 1 : i8} : memref<64x1x50264xf32>
        }
      }
    }
    affine.for %arg3 = 0 to 64 {
        ...
        affine.for %arg5 = 0 to 50264 step 8 {
          affine.for %arg6 = 0 to 768 step 8 {
            ...
            affine.for %arg7 = 0 to 1 {
              ...
              %71 = vector.load %alloc_144[%arg3, %70, %arg5] {remote_check_use = 1 : i8} : memref<64x1x50264xf32>, vector<8xf32>
              ...
              %73 = vector.broadcast %72 : f32 to vector<8xf32>
              %74 = vector.load %alloc_32[%arg6, %arg5] {remote_check_use = 1 : i8} : memref<768x50264xf32>, vector<8xf32>
              %75 = affine.load %alloca[0] : memref<1xvector<8xf32>>
              %76 = vector.fma %73, %74, %75 {remote_check_use = 1 : i8} : vector<8xf32>
              affine.store %76, %alloca[0] {remote_check_use = 1 : i8} : memref<1xvector<8xf32>>
              ...
              %79 = vector.broadcast %78 : f32 to vector<8xf32>
              %80 = vector.load %alloc_32[%77, %arg5] {remote_check_use = 1 : i8} : memref<768x50264xf32>, vector<8xf32>
              %81 = affine.load %alloca[0] : memref<1xvector<8xf32>>
              %82 = vector.fma %79, %80, %81 {remote_check_use = 1 : i8} : vector<8xf32>
              affine.store %82, %alloca[0] {remote_check_use = 1 : i8} : memref<1xvector<8xf32>>
              ...
              %85 = vector.broadcast %84 : f32 to vector<8xf32>
              %86 = vector.load %alloc_32[%83, %arg5] {remote_check_use = 1 : i8} : memref<768x50264xf32>, vector<8xf32>
              %87 = affine.load %alloca[0] : memref<1xvector<8xf32>>
              %88 = vector.fma %85, %86, %87 {remote_check_use = 1 : i8} : vector<8xf32>
              affine.store %88, %alloca[0] {remote_check_use = 1 : i8} : memref<1xvector<8xf32>>
              ...
              %91 = vector.broadcast %90 : f32 to vector<8xf32>
              %92 = vector.load %alloc_32[%89, %arg5] {remote_check_use = 1 : i8} : memref<768x50264xf32>, vector<8xf32>
              %93 = affine.load %alloca[0] : memref<1xvector<8xf32>>
              %94 = vector.fma %91, %92, %93 {remote_check_use = 1 : i8} : vector<8xf32>
              affine.store %94, %alloca[0] {remote_check_use = 1 : i8} : memref<1xvector<8xf32>>
              ...
              %97 = vector.broadcast %96 : f32 to vector<8xf32>
              %98 = vector.load %alloc_32[%95, %arg5] {remote_check_use = 1 : i8} : memref<768x50264xf32>, vector<8xf32>
              %99 = affine.load %alloca[0] : memref<1xvector<8xf32>>
              %100 = vector.fma %97, %98, %99 {remote_check_use = 1 : i8} : vector<8xf32>
              affine.store %100, %alloca[0] {remote_check_use = 1 : i8} : memref<1xvector<8xf32>>
              ...
              %103 = vector.broadcast %102 : f32 to vector<8xf32>
              %104 = vector.load %alloc_32[%101, %arg5] {remote_check_use = 1 : i8} : memref<768x50264xf32>, vector<8xf32>
              %105 = affine.load %alloca[0] : memref<1xvector<8xf32>>
              %106 = vector.fma %103, %104, %105 {remote_check_use = 1 : i8} : vector<8xf32>
              affine.store %106, %alloca[0] {remote_check_use = 1 : i8} : memref<1xvector<8xf32>>
              ...
              %109 = vector.broadcast %108 : f32 to vector<8xf32>
              %110 = vector.load %alloc_32[%107, %arg5] {remote_check_use = 1 : i8} : memref<768x50264xf32>, vector<8xf32>
              %111 = affine.load %alloca[0] : memref<1xvector<8xf32>>
              %112 = vector.fma %109, %110, %111 {remote_check_use = 1 : i8} : vector<8xf32>
              affine.store %112, %alloca[0] {remote_check_use = 1 : i8} : memref<1xvector<8xf32>>
              ...
              %115 = vector.broadcast %114 : f32 to vector<8xf32>
              %116 = vector.load %alloc_32[%113, %arg5] {remote_check_use = 1 : i8} : memref<768x50264xf32>, vector<8xf32>
              %117 = affine.load %alloca[0] : memref<1xvector<8xf32>>
              %118 = vector.fma %115, %116, %117 {remote_check_use = 1 : i8} : vector<8xf32>
              affine.store %118, %alloca[0] {remote_check_use = 1 : i8} : memref<1xvector<8xf32>>
              %119 = affine.load %alloca[0] : memref<1xvector<8xf32>>
              vector.store %119, %alloc_144[%arg3, %70, %arg5] {remote_check_use = 1 : i8} : memref<64x1x50264xf32>, vector<8xf32>
            }
          }
        }
      }
    }
    return {remote_check_use = 1 : i8} %alloc_144 : memref<64x1x50264xf32>
  }
}
