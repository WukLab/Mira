module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func @expand(%arg0: !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A">>>)>>>, %arg1: i32) -> !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A">>>)>>> {
    ...
    %2 = rmem.llvm.getelementptr %1[ [0, 0]] : (!rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A">>>)>>>) -> !rmem.rmref<1, !llvm.ptr<struct<(i32)>>>
    %3 = rmem.llvm.getelementptr %2[ [0, 0]] : (!rmem.rmref<1, !llvm.ptr<struct<(i32)>>>) -> !rmem.rmref<1, !llvm.ptr<i32>>
    rmem.llvm.store %arg1 -> %3 : i32, !rmem.rmref<1, !llvm.ptr<i32>>
    %4 = rmem.llvm.getelementptr %1[ [0, 1]] : (!rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A">>>)>>>) -> !rmem.rmref<1, !llvm.ptr<!rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A">>>)>>>>>
    ...
    %6 = rmem.llvm.getelementptr %arg0[ [0, 1]] : (!rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A">>>)>>>) -> !rmem.rmref<1, !llvm.ptr<!rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A">>>)>>>>>
  ...
  func.func @visit(%arg0: i32) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %4 = rmem.llvm.getelementptr %1[%3 []] : (!llvm.ptr<!rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A">>>)>>>>, i64) -> !llvm.ptr<!rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A">>>)>>>>
    ...
    ^bb0(%arg1: !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A">>>)>>>):
      %13 = rmem.llvm.getelementptr %arg1[ [0, 0]] : (!rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A">>>)>>>) -> !llvm.ptr<struct<(i32)>>
      %14 = rmem.llvm.getelementptr %13[ [0, 0]] : (!llvm.ptr<struct<(i32)>>) -> !rmem.rmref<1, !llvm.ptr<i32>>
      %15 = rmem.llvm.load %14 : (!rmem.rmref<1, !llvm.ptr<i32>>) -> i32
      %16 = llvm.call @printf(%11, %15) : (!llvm.ptr<i8>, i32) -> i32
      %17 = rmem.llvm.getelementptr %arg1[ [0, 1]] : (!rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A">>>)>>>) -> !rmem.rmref<1, !llvm.ptr<!rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A">>>)>>>>>
  ...
  func.func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %13 = scf.for %arg2 = %c0 to %12 step %c1 iter_args(%arg3 = %0) -> (!rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A">>>)>>>) {
      ...
      %19 = rmem.llvm.getelementptr %17[%18 []] : (!llvm.ptr<!rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A">>>)>>>>, i64) -> !llvm.ptr<!rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@polygeist@mlir@struct.A">>>)>>>>
