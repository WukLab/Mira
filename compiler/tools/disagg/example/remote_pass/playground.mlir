Args: ./bin/standalone-pg ../example/from_cg/playground.mlir -debug 
...
//===-------------------------------------------===//
Legalizing operation : 'builtin.module'(0x7fa67c10f920) {
} -> SUCCESS : operation marked legal by the target
//===-------------------------------------------===//

//===-------------------------------------------===//
Legalizing operation : 'func.func'(0x7fa67c112ba0) {
} -> SUCCESS : operation marked legal by the target
//===-------------------------------------------===//

//===-------------------------------------------===//
Legalizing operation : 'memref.reshape'(0x7fa67c112b10) {
  %0 = "memref.reshape"(%arg0, %arg1) : (memref<2x3xi32>, memref<1xi32>) -> memref<6xi32>

} -> SUCCESS : operation marked legal by the target
//===-------------------------------------------===//

//===-------------------------------------------===//
Legalizing operation : 'func.return'(0x7fa67c111070) {
...
//===-------------------------------------------===//
Legalizing operation : 'func.func'(0x7fa67c1110e0) {
} -> SUCCESS : operation marked legal by the target
//===-------------------------------------------===//

//===-------------------------------------------===//
Legalizing operation : 'memref.alloc'(0x7fa67c10f050) {
...
//===-------------------------------------------===//
Legalizing operation : 'memref.alloc'(0x7fa67c10f0b0) {
...
//===-------------------------------------------===//
Legalizing operation : 'func.call'(0x7fa67c1136c0) {
...
//===-------------------------------------------===//
Legalizing operation : 'memref.dealloc'(0x7fa67c113780) {
...
//===-------------------------------------------===//
Legalizing operation : 'func.return'(0x7fa67c1137f0) {
  "func.return"() : () -> ()
...
Trying to match "mlir::(anonymous namespace)::MemRefAllocDisagg"
ImplicitTypeIDRegistry::lookupOrInsert(mlir::OpTrait::OneTypedResult<mlir::rmem::RemoteMemRefType>::Impl<Empty>)
    ** Insert  : 'rmem.alloc_memref'(0x7fa67c10f990)
    ** Replace : 'memref.alloc'(0x7fa67c10f050)
"mlir::(anonymous namespace)::MemRefAllocDisagg" result 1

    //===-------------------------------------------===//
    Legalizing operation : 'rmem.alloc_memref'(0x7fa67c10f990) {
      %0 = "rmem.alloc_memref"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> !rmem.rmref<memref<2x3xi32>>
...
func.func @main() {
  %0 = rmem.alloc_memref() : !rmem.rmref<memref<2x3xi32>>
  %1 = memref.alloc() : memref<2x3xi32>
  %2 = memref.alloc() : memref<1xi32>
  %3 = call @memref_reshape(%1, %2) : (memref<2x3xi32>, memref<1xi32>) -> memref<6xi32>
  memref.dealloc %3 : memref<6xi32>
  return
}
...
Legalizing operation : 'memref.alloc'(0x7fa67c10f0b0) {
  ...
  * Pattern : 'memref.alloc -> ()' {
Trying to match "mlir::(anonymous namespace)::MemRefAllocDisagg"
    ** Insert  : 'rmem.alloc_memref'(0x7fa67c10f610)
    ** Replace : 'memref.alloc'(0x7fa67c10f0b0)
"mlir::(anonymous namespace)::MemRefAllocDisagg" result 1

    //===-------------------------------------------===//
    Legalizing operation : 'rmem.alloc_memref'(0x7fa67c10f610) {
      %2 = "rmem.alloc_memref"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> !rmem.rmref<memref<1xi32>>
...
func.func @main() {
  %0 = rmem.alloc_memref() : !rmem.rmref<memref<2x3xi32>>
  %1 = memref.alloc() : memref<2x3xi32>
  %2 = rmem.alloc_memref() : !rmem.rmref<memref<1xi32>>
  %3 = memref.alloc() : memref<1xi32>
  %4 = call @memref_reshape(%1, %3) : (memref<2x3xi32>, memref<1xi32>) -> memref<6xi32>
  memref.dealloc %4 : memref<6xi32>
  return
}
...
//===-------------------------------------------===//
Legalizing operation : 'func.call'(0x7fa67c1136c0) {
  %4 = "func.call"(%1, %3) {callee = @memref_reshape} : (memref<2x3xi32>, memref<1xi32>) -> memref<6xi32>
...
//===-------------------------------------------===//
** Insert  : 'rmem.materialize'(0x7fa67c00ed70)
** Insert  : 'rmem.materialize'(0x7fa67c404570)
...
Trying to match "mlir::(anonymous namespace)::FuncOpDisagg"
    ** Insert  : 'func.func'(0x7fa67c405360)
    ** Erase   : 'func.func'(0x7fa67c112ba0)
"mlir::(anonymous namespace)::FuncOpDisagg" result 1

    //===-------------------------------------------===//
    Legalizing operation : 'func.func'(0x7fa67c405360) {
    } -> SUCCESS : operation marked legal by the target
    //===-------------------------------------------===//
  } -> SUCCESS : pattern applied successfully
// *** IR Dump After Pattern Application ***
...
"builtin.module"() ({
  ...
  "func.func"() ({
    %0 = "rmem.alloc_memref"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> !rmem.rmref<memref<2x3xi32>>
    %1 = "rmem.materialize"(%0) : (!rmem.rmref<memref<2x3xi32>>) -> memref<2x3xi32>
    %2 = "rmem.alloc_memref"() {operand_segment_sizes = dense<0> : vector<2xi32>} : () -> !rmem.rmref<memref<1xi32>>
    %3 = "rmem.materialize"(%2) : (!rmem.rmref<memref<1xi32>>) -> memref<1xi32>
    %4 = "func.call"(%1, %3) {callee = @memref_reshape} : (memref<2x3xi32>, memref<1xi32>) -> memref<6xi32>
    "memref.dealloc"(%4) : (memref<6xi32>) -> ()
    "func.return"() : () -> ()
...
Trying to match "mlir::(anonymous namespace)::FuncReturnOpDisagg"
    ** Insert  : 'func.return'(0x7fa67c3045e0)
    ** Replace : 'func.return'(0x7fa67c111070)
"mlir::(anonymous namespace)::FuncReturnOpDisagg" result 1

    //===-------------------------------------------===//
    Legalizing operation : 'func.return'(0x7fa67c3045e0) {
...
//===-------------------------------------------===//
Legalizing operation : 'rmem.materialize'(0x7fa67c00ed70) {
  %1 = "rmem.materialize"(%0) : (!rmem.rmref<memref<2x3xi32>>) -> memref<2x3xi32>
...
//===-------------------------------------------===//
Legalizing operation : 'rmem.materialize'(0x7fa67c404570) {
  %3 = "rmem.materialize"(%2) : (!rmem.rmref<memref<1xi32>>) -> memref<1xi32>
...
Trying to match "mlir::(anonymous namespace)::FuncCallOpDisagg"
    ** Insert  : 'func.call'(0x7fa67af12ef0)
    ** Replace : 'func.call'(0x7fa67c1136c0)
"mlir::(anonymous namespace)::FuncCallOpDisagg" result 1

    //===-------------------------------------------===//
    Legalizing operation : 'func.call'(0x7fa67af12ef0) {
      %6 = "func.call"(%2, %5) {callee = @memref_reshape} : (!rmem.rmref<memref<2x3xi32>>, !rmem.rmref<memref<1xi32>>) -> !rmem.rmref<memref<6xi32>>
...
func.func @main() {
  %0 = rmem.alloc_memref() : !rmem.rmref<memref<2x3xi32>>
  %1 = rmem.materialize %0 : (!rmem.rmref<memref<2x3xi32>>) -> memref<2x3xi32>
  %2 = builtin.unrealized_conversion_cast %1 : memref<2x3xi32> to !rmem.rmref<memref<2x3xi32>>
  %3 = rmem.alloc_memref() : !rmem.rmref<memref<1xi32>>
  %4 = rmem.materialize %3 : (!rmem.rmref<memref<1xi32>>) -> memref<1xi32>
  %5 = builtin.unrealized_conversion_cast %4 : memref<1xi32> to !rmem.rmref<memref<1xi32>>
  %6 = call @memref_reshape(%2, %5) : (!rmem.rmref<memref<2x3xi32>>, !rmem.rmref<memref<1xi32>>) -> !rmem.rmref<memref<6xi32>>
  %7 = call @memref_reshape(%1, %4) : (memref<2x3xi32>, memref<1xi32>) -> memref<6xi32>
  memref.dealloc %7 : memref<6xi32>
  return
}
...
//===-------------------------------------------===//
** Insert  : 'rmem.virtualize'(0x7fa67c208be0)
** Insert  : 'rmem.virtualize'(0x7fa67c208c60)
** Insert  : 'rmem.virtualize'(0x7fa67c208ce0)
** Insert  : 'rmem.materialize'(0x7fa67c2089b0)
** Insert  : 'rmem.materialize'(0x7fa67c208aa0)
** Insert  : 'rmem.materialize'(0x7fa67c208b20)
mlir-asm-printer: Verifying operation: builtin.module
module {
  ...
  func.func @main() {
    %0 = rmem.alloc_memref() : !rmem.rmref<memref<2x3xi32>>
    %1 = rmem.materialize %0 : (!rmem.rmref<memref<2x3xi32>>) -> memref<2x3xi32>
    %2 = rmem.virtualize(%1) : (memref<2x3xi32>) -> !rmem.rmref<memref<2x3xi32>>
    %3 = rmem.alloc_memref() : !rmem.rmref<memref<1xi32>>
    %4 = rmem.materialize %3 : (!rmem.rmref<memref<1xi32>>) -> memref<1xi32>
    %5 = rmem.virtualize(%4) : (memref<1xi32>) -> !rmem.rmref<memref<1xi32>>
    %6 = call @memref_reshape(%2, %5) : (!rmem.rmref<memref<2x3xi32>>, !rmem.rmref<memref<1xi32>>) -> !rmem.rmref<memref<6xi32>>
    %7 = rmem.materialize %6 : (!rmem.rmref<memref<6xi32>>) -> memref<6xi32>
    memref.dealloc %7 : memref<6xi32>
    return
  }
}
